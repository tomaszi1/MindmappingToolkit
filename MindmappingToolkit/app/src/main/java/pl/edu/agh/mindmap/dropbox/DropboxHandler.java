...
public class DropboxHandler {
    ...
    public DropboxHandler(Context appContext, String appKey, String appSecret) {
        if (appContext == null)
            throw new NullPointerException("Application context was null");
        AndroidAuthSession session = new AndroidAuthSession(new AppKeyPair(appKey, appSecret));
    ...
    /**
     * Starts activity in which user gives app the permission to access Dropbox.

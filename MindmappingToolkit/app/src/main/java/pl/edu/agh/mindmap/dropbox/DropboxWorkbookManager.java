...
public class DropboxWorkbookManager {
    ...
    private DropboxBrowser.DbxFile dbxFile;
    private final DropboxHandler dbxHandler;

    private DropboxWorkbookManager(IWorkbook workbook, DropboxBrowser.DbxFile dbxFile, DropboxHandler dbxHandler) {
    ...
    public DropboxBrowser.DbxFile getDropboxFile() {
        return dbxFile;
    }
     ...
     */
    public static DropboxWorkbookManager bindWorkbookToDropboxFile(IWorkbook workbook, DropboxBrowser.DbxFile file, DropboxHandler handler) {
        if (file.isDir())
     ...
     */
    public static void downloadWorkbook(DropboxBrowser.DbxFile workbookFile, final ResultListener<DropboxWorkbookManager, Exception> resultListener, final DropboxHandler handler) {
    ...
    private static class WorkbookLoader extends AsyncTask<Void, Void, DropboxWorkbookManager> {
        ...
        protected DropboxWorkbookManager doInBackground(Void... voids) {
            try {
                ...
                return new DropboxWorkbookManager(workbook, new DropboxBrowser.DbxFile(dbxFile), dropboxHandler);
            } catch (IOException e) {
                ex = e;
            ...
            try {
                ...
                TaskCanceller dbxCanceller = dbxHandler.uploadFile(dbxFile.getPath(), bais, bytes.length, new ResultListener<DropboxAPI.Entry, DropboxException>() {
                    ...
                    public void taskDone(DropboxAPI.Entry result) {
                        ...
                        dbxFile = new DropboxBrowser.DbxFile(result);
